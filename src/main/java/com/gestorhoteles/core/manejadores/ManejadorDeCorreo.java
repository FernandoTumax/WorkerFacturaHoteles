package com.gestorhoteles.core.manejadores;
...
public class ManejadorDeCorreo {
    ...
    public synchronized void enviarCorreoRegistro(String asuntoMensaje, String tituloMensaje, String cuerpoMensaje, String pieMensaje, String correoDestino) throws Exception{
        ...
        // Propiedades de la conexión
                ...
                //Datos del remitente
                message.setFrom(new InternetAddress("webservices@kinal.edu.gt"));
                ...
                String filename = "C:\\Reporte\\FacturacionGestorHoteles.pdf";//change accordingly
        ...
        t.connect("webservices@kinal.edu.gt", "Kin@l2016");
